  ...
  const coreInternalLinks = [
    {
      ...
      icon: "🏠",
      description: "Personalized hair loss treatment plans with expert diagnosis"
    },
    {
      to: "/take-hair-test",
  ...
  const pageSpecificLinks = {
    treatment: [
      ...
      },
      {
        ...
        icon: "🔄",
        description: "Advanced hair transplant techniques for natural restoration"
      },
      {
  ...
  const authorityExternalLinks = [
    {
      ...
      icon: "🔬",
      description: "Scientific research on hair loss and treatments",
      rel: "nofollow noopener"
    },
    {
      href: "https://www.aad.org/public/diseases/hair-loss",
      text: "Hair Loss Guide - AAD",
      icon: "🏥",
      description: "American Academy of Dermatology hair loss information",
      rel: "nofollow noopener"
    },
    {
      href: "https://www.webmd.com/skin-problems-and-treatments/hair-loss/",
      text: "Hair Loss Information - WebMD",
      icon: "📚",
      description: "Comprehensive hair loss information and treatments",
      rel: "nofollow noopener"
    },
    {
      href: "https://www.mayoclinic.org/diseases-conditions/hair-loss/symptoms-causes/syc-20372926",
      text: "Hair Loss Causes - Mayo Clinic",
      icon: "🏥",
      description: "Medical information about hair loss causes and symptoms",
      rel: "nofollow noopener"
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Comprehensive hair care resources, expert information, and trusted links for hair loss treatment",
            "mainEntity": {
              "@type": "ItemList",
              "itemListElement": getRelevantInternalLinks().map((link, index) => ({
                "@type": "ListItem",
                "position": index + 1,
                "name": link.text,
