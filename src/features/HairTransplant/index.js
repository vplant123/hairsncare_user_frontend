        ...
        >
          ...
          <div className="main-div-resp">
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <div
                  className="text-3-section-4-htw m-text-left mfs-1"
                  style={{ width: "75%" }}
                >
                  <div
                    dangerouslySetInnerHTML={{
            ...
            >
              ...
              >
                ...
                >
                  <div
                    dangerouslySetInnerHTML={{
                      __html: content?.section5?.footerText,
                    }}
                  />
                </div>
              </div>
          ...
          <div className="container mt-3 main-div-resp">
            ...
            <div className="mt-5 d-flex flex-column">
              ...
              >
                Don’t let hair loss control your life. Whether you’re
                considering FUE, DHI, or MHI, let’s work together to find the
                best solution for you. Start your journey by scheduling your
                consultation today!
              </div>
            </div>
          </div>
