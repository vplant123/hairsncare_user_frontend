...
export default function Page2({ data }) {
  ...
  return (
    ...
    <div style={{display : "flex",justifyContent : "center",margin : "20px 0"}}>
        <div className="page-2-sec-1-main darttl" style={{fontSize : "20px",fontWeight : "700"}}>
    ...
    <div className="d-flex darpanel" style={{gap : "3%"}}>
        ...
        <div style={{width: "30%",fontSize: "9px"}} className="darcol">
            Hair loss and thinning can arise from various factors, with nutritional deficiencies being a significant contributor. Essential nutrients for healthy hair growth include iron, zinc, biotin, vitamins D, A, E, and C, protein, and omega-3 fatty acids. For
    ...
    <div className="d-flex darpanel" style={{gap : "3%"}}>
        ...
        <div style={{width: "30%",fontSize: "9px"}} className="darcol">
            Lifestyle assessments are vital for understanding hair loss, as daily habits significantly impact hair health. Unhealthy choices, including poor nutrition, chronic stress, and smoking, can lead to issues like nutrient deficiencies and hormonal imbalances.
    ...
    <div className="d-flex mt-3 darcol" style={{justifyContent : "center",alignItems : "center"}}>
        <div style={{width : "70%",fontSize : "12px",textAlign : "center"}}>
    ...
    <div className="partBottomDesc mt-2">
      <p><strong>Legal Disclaimer</strong>: This communication aims to ensure your comprehensive understanding of the diagnosis's nature. (Read more.. Please be cognizant that, as of this juncture, the diagnosis is regarded as provisional,
        ...
        hereby acknowledge the potential divergence in individual cases, thus warranting judicious discretion during the interpretation of outcomes.) Diagnosis & Details</p>
    </div>
