        ...
        <div className='d-flex flex-column page-break-2' style={{justifyContent : "space-between"}}>
          ...
          <div class="diet-sec">
            <div class="diet-heading">
              <h2 style={{fontSize : "22px",fontWeight : "600", padding: "15px 10px"}}>Importance of Diet in Hair loss and hair thinning</h2>
            </div>
            <div class="diet-flex">
          ...
          <div class="faq-titledesign mbfaq-titledesignOne" style={{width : "80%"}}>
            <div class="faq-box1">
            </div>
            <div class="faq-box2">
      ...
      <div style={{display : "flex",justifyContent : "center"}} className='mt-5'>
        <div class="breakfast-titlebox" style={{    width: "40%",height : "100px"}}>
          <div class="breakfast-flextitle">
            <div class="breakfast-title" style={{transform: "skew(-20deg)",width:"60%",paddingLeft: "20px", fontWeight: "700"}}>
              Breakfast
            </div>
          <div style={{ width: "40%"}}>
