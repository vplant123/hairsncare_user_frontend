    ...
    <>
              ...
              return (
                <div
                  onClick={() => {
                    ...
                    if (ind == 3) {
                      window.open(
                        "https://www.instagram.com/hairsncares/?hl=en"
                      );
                    }
                    if (ind == 4) {
      ...
      <div className="about-section-2 container">
        ...
        <RightAnimatedDiv className="image-2 ">
          <img
            alt="Hand holding healthy brown hair, representing the commitment of Hairsncares to quality hair care and scalp health solutions."
            src={content?.section2?.img}
        ...
        <div className="container">
          ...
          <div className="content-3">
            <ZoomInDiv className="content-container ">
              <img
                alt="Doctor at Hairsncares specializing in hair loss and scalp care, symbolizing the journey and expertise in hair health solutions."
              ...
              {content?.section3?.data?.map((e, ind) => {
                return (
                  <div className="content-item">
                    <span>0{ind + 1}</span>
                    <div>
                      <h3 className="content-sub-item">{e?.title}</h3>
                      {/* <p> */}
                      <div
      ...
      <div className="about-container-3 container">
        <LeftAnimatedDiv className="container-3-item ">
          <img
            alt="Applying hair treatment serum as part of Hairsncares comprehensive approach to hair loss and scalp care solutions"
      ...
      <div className="about-container-4 container">
        <div className="head-2-container">
          <h2 className="contect-us-heading-2">{content?.section5?.title}</h2>
        </div>
                ...
                <LeftAnimatedDiv className="commit-item">
                  <div>
                    <div className="commit-sub">
                      <img
                        alt={ind == "0" ? "Vision icon" : "Our icon"}
