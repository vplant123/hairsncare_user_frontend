...
import HairReport from "./doctor-analyse/HairReport";
import SpeedoMeter from "./doctor-analyse/SpeedoMeter";
...
export default function DoctorAnalyseReport(props) {
...
const [loading,setLoading] = useState(false)
  ...
  //       let position = margin;
  //       console.log("keor",position,imgWidth, imgHeight,canvas.height,canvas.width)
  //       pdf.addImage(imgData, "PNG", margin, position, imgWidth, imgHeight);
  //       heightLeft -= pageHeight;
  //       console.log("tstttt1",margin, position, heightLeft)
  //       while (heightLeft >= 0) {
  //         position = heightLeft - imgHeight-margin;
  //         console.log("tstttt2",margin, position,heightLeft)
  //         pdf.addPage();
  //         pdf.addImage(imgData, "PNG", margin, position, imgWidth, imgHeight);
  //         heightLeft -= pageHeight;
  //       }

  //       pdf.save(`${data?.personal?.name}-Report.pdf`);
  ...
  const generatePDF = () => {
    ...
    const opt = {
      ...
      filename: `${data?.personal?.name}-Report.pdf`,
