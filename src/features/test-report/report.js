...
export default function TestReport() {
  ...
  const lifestyleImpactImage = `${process.env.PUBLIC_URL}/report-image/IMG-2110.png`;
  const nutritionalEggImage = `${process.env.PUBLIC_URL}/report-image/IMG-2146.png`;
  const nutritionalIronImage = `${process.env.PUBLIC_URL}/report-image/IMG-2176.png`;
  const stressProtocolImage = `${process.env.PUBLIC_URL}/report-image/IMG-2808.png`;
  const shaftScalpImage = `${process.env.PUBLIC_URL}/report-image/IMG-3366.png`;
  const aiPhotoImageFront = `${process.env.PUBLIC_URL}/report-image/IMG-562.png`;
  const aiPhotoImageCrown = `${process.env.PUBLIC_URL}/report-image/IMG-579.png`;
  const aiPhotoImageTemple = `${process.env.PUBLIC_URL}/report-image/IMG-596.png`;
  ...
  const aiPhotoTiles = [
    {
      ...
      zone: "Recession zone",
      image: aiPhotoImageFront,
      markerTop: "37%",
      markerLeft: "48%",
    },
    {
      id: "crown-view",
      label: "Crown / Top View",
      zone: "Thinning zone",
      image: aiPhotoImageCrown,
      markerTop: "44%",
      markerLeft: "52%",
    },
    {
        ...
        <div className="left-report-column">
          ...
          <article className="report-diagnostic-panel">
              ...
              <div className="report-identity-row">
                <div className="id-icon-wrap">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00E5FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4.8 2.3A.3.3 0 1 0 5 2a.3.3 0 1 0-.2.3Z"></path>
                    <path d="M10 2v2"></path>
                    <path d="M7 2h6"></path>
                    <path d="M10 4a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z"></path>
                    <path d="M10 10v3"></path>
                    <path d="M20 12v3"></path>
                    <path d="M17 12h6"></path>
                    <path d="M20 15a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2Z"></path>
                    <path d="M20 21v1"></path>
                    <path d="M10 13a7 7 0 0 0-7 7v2"></path>
                  </svg>
                </div>
            ...
            <div className="clinical-hero-copy">
              ...
              <p className="report-summary-text">
                AI-generated clinical assessment based on your questionnaire inputs. Results indicate hair health status and contributing factors. This is not a medical diagnosis — consult a qualified trichologist for clinical confirmation.
              </p>
            </div>
          ...
          <article className="medical-review-card">
            <div className="medical-card-head">
              <span className="medical-card-head-left">
                ...
                <span className="verification-label-text">Medical Review & Verification</span>
              </span>
          ...
          >
            <article className="ai-photo-analysis-card">
              <header className="ai-photo-analysis-header">
                <div className="ai-photo-analysis-title-wrap">
                  <span className="ai-photo-analysis-header-icon" aria-hidden="true">
                    <svg
                      width="19"
                      height="18"
                      viewBox="0 0 19 18"
                  ...
                  <div>
                    ...
                    <p>Visual scalp analysis powered by AI for enhanced accuracy</p>
                  </div>
                </div>
              </header>
                  ...
                  >
                    {!item.unavailable ? (
                      <>
                        ...
                        >
                          <span className="ai-photo-zone-ring" aria-hidden="true">
                            <svg
                              width="52"
                              height="52"
                              viewBox="0 0 52 52"
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <circle cx="26" cy="26" r="14" fill="#F4C430" fillOpacity="0.2" stroke="#F4C430" strokeOpacity="0.7" />
                              <circle cx="26" cy="26" r="6" fill="#F4C430" fillOpacity="0.85" />
                            </svg>
                          </span>
                          <span className="ai-photo-zone-pill">{item.zone}</span>
                        </div>
                      ...
                      <div className="ai-photo-missing-wrap">
                        <div className="ai-photo-missing-icon" aria-hidden="true">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <span className="ai-photo-missing-pill">Not Provided</span>
                      </div>
                    )}
                  </article>
                ))}
            ...
            <article className="ai-questionnaire-correlation-card">
              <h4>
                <span className="ai-questionnaire-correlation-icon" aria-hidden="true">
                  <svg
                    width="17"
                    height="16"
                    viewBox="0 0 17 16"
              ...
              <p>
                Photo analysis <strong>confirms</strong> early-stage thinning patterns detected in your
                questionnaire responses. Visual data indicates crown density reduction is
                slightly more advanced than self-reported data - consistent with gradual onset.
              </p>
            </article>
                ...
                <article className="ai-photo-metric-card" key={item.title}>
                  ...
                  <p className="ai-photo-metric-value-row">
                    {item.tone === "confidence" && (
                      <span className="ai-photo-confidence-icon" aria-hidden="true">
                        <svg
                          width="17"
                          height="16"
                          viewBox="0 0 17 16"
                ...
                {nutritionalProtocolCards.map((item) => (
                  <article className="nutritional-card" key={item.title}>
                    <div className="nutritional-card-head">
                      <span
                        className={`nutritional-card-icon nutritional-card-icon-${item.tone}`}
                        aria-hidden="true"
                      >
                        {item.icon === "chain" && (
                          <svg
                        ...
                        {item.icon === "shield" && (
                          ...
                          >
                            <path
                              d="M2.49585 1.64533L7.28914 0.583659L12.0824 1.64533C12.2146 1.67644 12.3235 1.74644 12.409 1.85533C12.4945 1.96421 12.5373 2.08477 12.5373 2.21699V8.03866C12.5373 8.62977 12.3993 9.18199 12.1232 9.69533C11.8472 10.2087 11.4643 10.6287 10.9745 10.9553L7.28914 13.417L3.60379 10.9553C3.11397 10.6287 2.73105 10.2087 2.45503 9.69533C2.17902 9.18199 2.04102 8.62977 2.04102 8.03866V2.21699C2.04102 2.08477 2.08378 1.96421 2.1693 1.85533C2.25483 1.74644 2.36368 1.67644 2.49585 1.64533ZM3.20727 2.68366V8.03866C3.20727 8.43533 3.29862 8.80477 3.48133 9.14699C3.66405 9.48921 3.91868 9.76921 4.24523 9.98699L7.28914 12.017L10.3331 9.98699C10.6596 9.76921 10.9142 9.48921 11.0969 9.14699C11.2797 8.80477 11.371 8.43533 11.371 8.03866V2.68366L7.28914 1.77366L3.20727 2.68366Z"
                              fill="currentColor"
                            />
                          </svg>
                        )}
                      ...
                      <div className="nutritional-card-title-wrap">
                        <h5>{item.title}</h5>
                        <p
                          className={`nutritional-dose nutritional-dose-${item.tone}`}
                        >
                          {item.dosage}
                        </p>
                      </div>
                    ...
                    {item.imageType && (
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${item.imageType === "egg" ? nutritionalEggImage : nutritionalIronImage})`,
                        }}
                        aria-hidden="true"
                      />
                    )}
                    ...
                    <ul
                      className="nutritional-food-list"
                      aria-label={`${item.title} food sources`}
                    >
                      {item.foods.map((food) => (
                        <li
                          key={food}
                          className={`nutritional-food-pill nutritional-food-pill-${item.tone}`}
                        >
                          {food}
                        </li>
                      ))}
                  ...
                  <article className="meal-plan-row" key={item.meal}>
                    ...
                    >
                      ...
                      {item.icon === "apple" && (
                        ...
                        >
                          <path
                            d="M8.07 2C8.15667 1.6 8.37 1.27333 8.71 1.02C9.05 0.766667 9.43667 0.626667 9.87 0.6C9.86333 0.98 9.73333 1.34333 9.48 1.69C9.24 2.02333 8.93667 2.26667 8.57 2.42C8.43667 2.47333 8.27 2.51333 8.07 2ZM3.86 6.28C3.86 7.08 4.06 7.78667 4.46 8.4C4.86 9.00667 5.36 9.31 5.96 9.31C6.20667 9.31 6.45333 9.26667 6.7 9.18C6.95333 9.09333 7.19333 9.00333 7.42 8.91C7.64667 8.81667 7.85 8.77 8.03 8.77C8.20333 8.77 8.40333 8.81667 8.63 8.91C8.86333 9.00333 9.10667 9.09333 9.36 9.18C9.61333 9.26667 9.86667 9.31 10.12 9.31C10.6733 9.31 11.15 9.03 11.55 8.47C11.9567 7.90333 12.1767 7.27667 12.21 6.59C11.9367 6.49667 11.6833 6.36 11.45 6.18C11.23 5.99333 11.0533 5.76667 10.92 5.5C10.7867 5.23333 10.72 4.95333 10.72 4.66C10.72 4.24667 10.85 3.87 11.11 3.53C11.37 3.18333 11.7133 2.95 12.14 2.83C11.92 2.45667 11.6033 2.16667 11.19 1.96C10.7767 1.75333 10.3267 1.65 9.84 1.65C9.48667 1.65 9.16333 1.7 8.87 1.8C8.58333 1.89333 8.29333 2.01333 8 2.16C7.71333 2.3 7.45 2.41333 7.21 2.5C6.97667 2.58 6.73 2.62 6.47 2.62C6.19 2.62 5.9 2.58 5.6 2.5C5.30667 2.42 5.03 2.31 4.77 2.17C4.51 2.02333 4.26667 1.90333 4.04 1.81C3.82 1.71667 3.6 1.67 3.38 1.67C2.8 1.67 2.31667 1.94333 1.93 2.49C1.55 3.03 1.36 3.66333 1.36 4.39C1.36 4.99 1.51667 5.62 1.83 6.28C2.13667 6.93333 2.51333 7.48 2.96 7.92L3.69 7.21C3.97333 6.93 4.03 6.62 3.86 6.28Z"
                            fill="currentColor"
                          />
                        </svg>
                      )}
              ...
              <div className="daily-routine-list">
                {dailyRoutineItems.map((item) => (
                  <article
                    ...
                    className={`daily-routine-row `}
                    key={item.label}
                  >
                    <span className="daily-routine-dot" aria-hidden="true">
                      <svg
                        width="6"
                        height="6"
                        viewBox="0 0 6 6"
                    ...
                    <p>
                      ...
                      <p>{item.action}</p>
                      <span className="daily-routine-note">- {item.note}</span>
                    </p>
                  </article>
                ))}
              </div>
                    ...
                    <div className="weekly-day-head">
                      ...
                      {day.locked && (
                        <span className="weekly-day-lock" aria-hidden="true">
                          ...
                          >
                            <path
                              d="M5.625 2.625H6.375C6.48 2.625 6.56875 2.66125 6.64125 2.73375C6.71375 2.80625 6.75 2.895 6.75 3V7.5C6.75 7.605 6.71375 7.69375 6.64125 7.76625C6.56875 7.83875 6.48 7.875 6.375 7.875H0.375C0.27 7.875 0.18125 7.83875 0.10875 7.76625C0.03625 7.69375 0 7.605 0 7.5V3C0 2.895 0.03625 2.80625 0.10875 2.73375C0.18125 2.66125 0.27 2.625 0.375 2.625H1.125V2.25C1.125 1.845 1.2275 1.4675 1.4325 1.1175C1.6325 0.7775 1.9025 0.5075 2.2425 0.3075C2.5925 0.1025 2.97 0 3.375 0C3.78 0 4.1575 0.1025 4.5075 0.3075C4.8475 0.5075 5.1175 0.7775 5.3175 1.1175C5.5225 1.4675 5.625 1.845 5.625 2.25V2.625ZM3 5.5275V6.375H3.75V5.5275C3.865 5.4575 3.95625 5.365 4.02375 5.25C4.09125 5.135 4.125 5.01 4.125 4.875C4.125 4.74 4.09125 4.615 4.02375 4.5C3.95625 4.385 3.865 4.29375 3.75 4.22625C3.635 4.15875 3.51 4.125 3.375 4.125C3.24 4.125 3.115 4.15875 3 4.22625C2.885 4.29375 2.79375 4.385 2.72625 4.5C2.65875 4.615 2.625 4.74 2.625 4.875C2.625 5.01 2.65875 5.135 2.72625 5.25C2.79375 5.365 2.885 5.4575 3 5.5275ZM4.875 2.625V2.25C4.875 1.98 4.8075 1.73 4.6725 1.5C4.5375 1.27 4.355 1.0875 4.125 0.9525C3.895 0.8175 3.645 0.75 3.375 0.75C3.105 0.75 2.855 0.8175 2.625 0.9525C2.395 1.0875 2.2125 1.27 2.0775 1.5C1.9425 1.73 1.875 1.98 1.875 2.25V2.625H4.875Z"
                              fill="#F4C430"
                            />
                          </svg>
                        </span>
          ...
          >
            ...
            <div className="stress-techniques-list">
              {stressReductionTechniques.map((item) => (
                <article className="stress-technique-card" key={item.title}>
                  <div>
                    <div className="stress-technique-head">
                      ...
                      >
                        ...
                        {item.icon === "progressive" && (
                          ...
                          >
                            <path
                              d="M5.64417 5.00039L3.58789 2.94206L4.17064 2.35039L6.81799 5.00039L4.17064 7.65039L3.58789 7.05872L5.64417 5.00039Z"
                              fill="currentColor"
                            />
                          </svg>
                        )}
          ...
          <section className="predictive-model-section" aria-label="Predictive Model">
            <header className="predictive-model-header">
              ...
              <div className="predictive-model-head-copy">
                <span className="predictive-model-kicker">Predictive Model</span>
            ...
            <article className="predictive-model-chart-card">
              <div className="predictive-model-chart-head">
                ...
                <div className="predictive-model-legend" aria-label="Chart legend">
                  <span>
              ...
              <div className="predictive-risk-rows">
                {predictiveRiskRows.map((row) => (
                  <div className="predictive-risk-row" key={row.label}>
                    ...
                    <div className="predictive-risk-values" aria-label={`${row.label} values`}>
                      <strong className="predictive-risk-value-red">Untreated: {row.untreated}</strong>
                      <strong className="predictive-risk-value-green">Treated: {row.treated}</strong>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <article className="predictive-outlook-card">
              ...
              <div className="predictive-outlook-copy">
                ...
                <p>
                  <strong>Positive with early intervention.</strong> Projected risk reduction of
                  <b> 65% over 5 years</b>.  with consistent treatment adherence.
                  Delay beyond 12+ months reduces follicle recovery potential significantly.
                  Current trajectory, if untreated, leads to Norwood Stage IV-V classification
                  within 4-5 years.
                </p>
          ...
          >
            <header className="shaft-scalp-insights-header">
              <span className="shaft-scalp-insights-header-icon" aria-hidden="true">
                <svg
                  width="19"
                  height="18"
                  viewBox="0 0 19 18"
              ...
              <div className="shaft-scalp-insights-head-copy">
                ...
                <p>Structural analysis of shaft integrity and scalp condition</p>
              </div>
            </header>

            <div className="shaft-scalp-insights-card-list">
              {shaftScalpInsightCards.map((item) => (
                <article
                  className={`shaft-scalp-insights-card${item.showImage ? " shaft-scalp-insights-card-has-image" : ""}`}
                  key={item.title}
                >
                          ...
                          >
                            ...
                            <defs>
                              <clipPath id="clip0_oiliness_1">
                                <rect width="14.5781" height="14" fill="white" />
                              </clipPath>
                            </defs>
                          </svg>
                        )}
            ...
            <article className="shaft-scalp-insights-note-card">
              <p className="shaft-scalp-insights-note-title">
                <span className="shaft-scalp-insights-note-icon" aria-hidden="true">
                  <svg
                    width="15"
                    height="14"
                    viewBox="0 0 15 14"
              ...
              <p className="shaft-scalp-insights-note-copy">
                Hair breakage (Q31), split ends (Q32), and texture quality (Q33) together form
                the <strong> Hair Shaft Integrity Index</strong>. Scalp oiliness (Q36) directly
                influences follicle microenvironment and DHT activity at the root. These factors
                respond well to the combined nutritional and lifestyle protocol above.
              </p>
            </article>
          </section>
          ...
          >
            <header className="blood-investigations-header">
              <span className="blood-investigations-title-icon" aria-hidden="true">
                <svg
                  width="19"
                  height="18"
                  viewBox="0 0 19 18"
              ...
              <div className="blood-investigations-head-copy">
                <div className="blood-investigations-title-row">
                  ...
                  <span className="blood-investigations-chip">LAB INVESTIGATIONS</span>
                </div>
            ...
            <article className="blood-investigations-note-card">
              <p className="blood-investigations-note-title">
                <span className="blood-investigations-note-icon" aria-hidden="true">
                  <svg
                    width="15"
                    height="14"
                    viewBox="0 0 15 14"
              ...
              <p className="blood-investigations-note-copy">
                Blood tests are essential first-line investigations in any trichology consultation.
                No AI diagnostic tool - including TrichoScan - can substitute laboratory data.
                These tests are recommended regardless of assessment findings and should be done
            ...
            <article className="blood-investigations-tip-card">
              <p className="blood-investigations-tip-title">
                <span className="blood-investigations-tip-icon" aria-hidden="true">
                  <svg
                    width="15"
                    height="14"
                    viewBox="0 0 15 14"
              ...
              <p className="blood-investigations-tip-copy">
                Share this report with your trichologist and request a full panel before your
                consultation. Bring printed results to your appointment for a
          ...
          <section className="clinical-summary-section" aria-label="Clinical Summary">
            <article className="clinical-summary-card">
              ...
              <div className="clinical-summary-list">
                <p className="clinical-summary-item">
                  ...
                  <strong> Ar £2 - Male Pattern Baldness - Norwood Stage II</strong>, classified under
                  <strong> Category 1 - Androgenetic Alopecia (Pattern Baldness)</strong>, staged as
                  <strong> Norwood Stage II</strong> - confirmatory trichoscopy and lab tests required.
                </p>

                <p className="clinical-summary-item">
                  Your <strong>Hair Health Index</strong> of
                  <strong className="clinical-summary-accent-cyan"> 91/100</strong> indicates generally
                  healthy hair requiring preventive monitoring.
                </p>

                <p className="clinical-summary-item">
                  The AI engine identifies <strong>Genetic / Androgenetic</strong> as the primary causal
                  factor
                  <strong className="clinical-summary-accent-red"> (61% probability)</strong>, with
                  <strong> Stress-Induced (Telogen)</strong> as a secondary contributor
                  <strong className="clinical-summary-accent-amber"> (39%)</strong>.
                </p>

                <p className="clinical-summary-item">
                  Recovery potential score:
                  <strong className="clinical-summary-accent-green"> 84/100</strong> - favourable
                  prognosis with consistent treatment adherence over <strong>6-12 months</strong>.
                </p>
              </div>
            </article>
          </section>
          ...
          >
            <article className="recovery-journey-card">
              <header className="recovery-journey-header">
                ...
                <p>Expert trichologists available for personalised consultation</p>
              </header>
              ...
              <div className="recovery-journey-actions-grid">
                ...
                >
                  <span className="recovery-journey-action-icon" aria-hidden="true">
                    <svg
                      width="19"
                      height="18"
                      viewBox="0 0 19 18"
              ...
              <button type="button" className="recovery-journey-download-btn">
                <span className="recovery-journey-action-icon" aria-hidden="true">
                  <svg
                    width="19"
                    height="18"
          ...
          <section className="share-results-section container">
            <div className="share-header">
              ...
              <p>Know someone with hair concerns? Share your assessment or refer <br /> them to TrichoScan AI for their own free assessment.</p>
            </div>
            ...
            <div className="share-actions-grid">
              ...
              <button className="share-btn btn-green">
                <svg width="20" height="28" viewBox="0 0 20 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.445 18.875L6.985 19.19C7.915 19.73 8.9225 20 10.0075 20C11.0925 20 12.1 19.725 13.03 19.175C13.93 18.645 14.645 17.93 15.175 17.03C15.725 16.1 16 15.09 16 14C16 12.91 15.725 11.9 15.175 10.97C14.645 10.07 13.93 9.355 13.03 8.825C12.1 8.275 11.09 8 10 8C8.91 8 7.9 8.275 6.97 8.825C6.07 9.355 5.355 10.07 4.825 10.97C4.275 11.9 4 12.9075 4 13.9925C4 15.0775 4.27 16.085 4.81 17.015L5.125 17.555L4.645 19.355L6.445 18.875ZM2.5 21.5L3.52 17.78C3.19 17.21 2.9375 16.6075 2.7625 15.9725C2.5875 15.3375 2.5 14.68 2.5 14C2.5 12.98 2.695 12.005 3.085 11.075C3.465 10.185 4.0025 9.3925 4.6975 8.6975C5.3925 8.0025 6.185 7.465 7.075 7.085C8.005 6.695 8.98 6.5 10 6.5C11.02 6.5 11.995 6.695 12.925 7.085C13.815 7.465 14.6075 8.0025 15.3025 8.6975C15.9975 9.3925 16.535 10.185 16.915 11.075C17.305 12.005 17.5 12.98 17.5 14C17.5 15.02 17.305 15.995 16.915 16.925C16.535 17.815 15.9975 18.6075 15.3025 19.3025C14.6075 19.9975 13.815 20.535 12.925 20.915C11.995 21.305 11.02 21.5 10 21.5C9.32 21.5 8.6625 21.4125 8.0275 21.2375C7.3925 21.0625 6.79 20.81 6.22 20.48L2.5 21.5ZM7.3 10.475C7.4 10.475 7.5 10.475 7.6 10.475L7.72 10.49C7.78 10.5 7.8375 10.5225 7.8925 10.5575C7.9475 10.5925 7.985 10.63 8.005 10.67C8.235 11.18 8.455 11.69 8.665 12.2C8.715 12.32 8.69 12.455 8.59 12.605C8.54 12.695 8.475 12.79 8.395 12.89L8.125 13.19L8.095 13.25C8.075 13.3 8.07 13.345 8.08 13.385C8.09 13.425 8.115 13.48 8.155 13.55L8.2 13.625C8.4 13.955 8.655 14.27 8.965 14.57L9.235 14.825C9.595 15.145 9.99 15.395 10.42 15.575L10.615 15.665C10.665 15.685 10.71 15.7 10.75 15.71L10.81 15.725C10.89 15.725 10.965 15.69 11.035 15.62C11.415 15.15 11.61 14.915 11.62 14.915C11.69 14.845 11.785 14.815 11.905 14.825C11.955 14.825 12 14.835 12.04 14.855L13.525 15.515C13.565 15.535 13.6 15.5625 13.63 15.5975C13.66 15.6325 13.675 15.67 13.675 15.71V15.725C13.675 15.815 13.67 15.905 13.66 15.995C13.63 16.225 13.585 16.41 13.525 16.55C13.485 16.63 13.43 16.705 13.36 16.775C13.29 16.845 13.21 16.915 13.12 16.985L13.03 17.06C12.94 17.11 12.84 17.165 12.73 17.225C12.54 17.325 12.335 17.38 12.115 17.39H12.055C11.895 17.4 11.775 17.405 11.695 17.405L11.26 17.33C10.18 17.05 9.22 16.54 8.38 15.8C8.29 15.72 8.155 15.59 7.975 15.41L7.9 15.335C7.24 14.675 6.75 13.99 6.43 13.28C6.26 12.91 6.175 12.555 6.175 12.215C6.175 11.745 6.315 11.325 6.595 10.955L6.625 10.925C6.685 10.845 6.74 10.78 6.79 10.73C6.88 10.64 6.955 10.58 7.015 10.55C7.095 10.51 7.19 10.485 7.3 10.475Z" fill="white" />
                </svg>
            ...
            <p className="share-disclaimer">Only your assessment summary text is shared — no personal health data or photos are ever transmitted during sharing.</p>
          </section>
          ...
          <section className="legal-notice-section container">
            ...
            <div className="legal-notice-grid">
                ...
                <div className="legal-card-head">
                  <div className="legal-card-icon icon-red">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 12C0 5.37258 5.37258 0 12 0H16C22.6274 0 28 5.37258 28 12V16C28 22.6274 22.6274 28 16 28H12C5.37258 28 0 22.6274 0 16V12Z" fill="#EF4444" fill-opacity="0.07" />
                      <path d="M12 0.5H16C22.3513 0.5 27.5 5.64873 27.5 12V16C27.5 22.3513 22.3513 27.5 16 27.5H12C5.64873 27.5 0.5 22.3513 0.5 16V12C0.5 5.64873 5.64873 0.5 12 0.5Z" stroke="#EF4444" stroke-opacity="0.157" />
                      <path d="M15.5 10H10.5V18H17.5V12H15.5V10ZM9.5 9.5C9.5 9.36 9.54833 9.24167 9.645 9.145C9.74167 9.04833 9.86 9 10 9H16L18.5 11.5V18.5C18.5 18.6333 18.4517 18.75 18.355 18.85C18.2583 18.95 18.14 19 18 19H10C9.86 19 9.74167 18.9517 9.645 18.855C9.54833 18.7583 9.5 18.64 9.5 18.5V9.5ZM13.5 15.5H14.5V16.5H13.5V15.5ZM13.5 11.5H14.5V14.5H13.5V11.5Z" fill="#EF4444" />
                    </svg>
                  </div>
                  <h4 className="medical-diagnosis-title">Not a Medical Diagnosis-3916</h4>
                </div>
                <p className="legal-card-body">
                  This report is a health information assessment generated by AI. It is NOT a clinical diagnosis and does not constitute medical advice. The term "Provisional Assessment" indicates an AI-generated impression only.
                </p>
              </article>
              ...
              <article className="legal-card">
                ...
                <p className="legal-card-body">
                  Always seek the advice of a qualified dermatologist or trichologist. Never disregard or delay professional medical consultation based on information from this tool.
                </p>
              </article>
              ...
              <article className="legal-card">
                <div className="legal-card-head">
                  <div className="legal-card-icon icon-cyan">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 12C0 5.37258 5.37258 0 12 0H16C22.6274 0 28 5.37258 28 12V16C28 22.6274 22.6274 28 16 28H12C5.37258 28 0 22.6274 0 16V12Z" fill="#00E5FF" fill-opacity="0.07" />
                      <path d="M12 0.5H16C22.3513 0.5 27.5 5.64873 27.5 12V16C27.5 22.3513 22.3513 27.5 16 27.5H12C5.64873 27.5 0.5 22.3513 0.5 16V12C0.5 5.64873 5.64873 0.5 12 0.5Z" stroke="#00E5FF" stroke-opacity="0.157" />
                      <g clip-path="url(#clip0_335_5469)">
                        <path d="M14 8.5L18.11 9.41C18.2233 9.43667 18.3167 9.49667 18.39 9.59C18.4633 9.68333 18.5 9.78667 18.5 9.9V14.89C18.5 15.3967 18.3817 15.87 18.145 16.31C17.9083 16.75 17.58 17.11 17.16 17.39L14 19.5L10.84 17.39C10.42 17.11 10.0917 16.75 9.855 16.31C9.61833 15.87 9.5 15.3967 9.5 14.89V9.9C9.5 9.78667 9.53667 9.68333 9.61 9.59C9.68333 9.49667 9.77667 9.43667 9.89 9.41L14 8.5ZM14 9.52L10.5 10.3V14.89C10.5 15.23 10.5783 15.5467 10.735 15.84C10.8917 16.1333 11.11 16.3733 11.39 16.56L14 18.3L16.61 16.56C16.89 16.3733 17.1083 16.1333 17.265 15.84C17.4217 15.5467 17.5 15.23 17.5 14.89V10.3L14 9.52ZM16.23 12.11L16.93 12.82L13.75 16L11.63 13.88L12.34 13.17L13.75 14.59L16.23 12.11Z" fill="#00E5FF" />
                      </g>
                      <defs>
                ...
                <p className="legal-card-body">
                  Your health data is processed under the Digital Personal Data Protection Act, 2023 (India). Scalp photos (if uploaded) are processed in-memory only and are not retained on any server.
                </p>
              </article>
              ...
              <article className="legal-card">
                ...
                <p className="legal-card-body">
                  Assessment outputs are generated by Anthropic Claude AI (a US-based service). By using this tool you acknowledge consent to this processing on the entry screen.
                </p>
              </article>
            </div>
          </section>
